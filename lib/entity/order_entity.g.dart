...
OrderEntity _$OrderEntityFromJson(Map<String, dynamic> json) {
  return OrderEntity(json['total'] as int, json['pages'] as int, json['limit'] as int, json['page'] as int,
      (json['list'] as List)?.map((e) => e == null ? null : ListData.fromJson(e as Map<String, dynamic>))?.toList());
}

Map<String, dynamic> _$OrderEntityToJson(OrderEntity instance) =>
    <String, dynamic>{'total': instance.total, 'pages': instance.pages, 'limit': instance.limit, 'page': instance.page, 'list': instance.list};
...
ListData _$ListDataFromJson(Map<String, dynamic> json) {
  return ListData(
      ...
      (json['goodsList'] as List)?.map((e) => e == null ? null : GoodsList.fromJson(e as Map<String, dynamic>))?.toList(),
      json['id'] as int,
...
GoodsList _$GoodsListFromJson(Map<String, dynamic> json) {
  return GoodsList(json['number'] as int, json['picUrl'] as String, (json['price'] as num)?.toDouble(), json['id'] as int, json['goodsName'] as String,
      (json['specifications'] as List)?.map((e) => e as String)?.toList());
}

Map<String, dynamic> _$GoodsListToJson(GoodsList instance) =>
    <String, dynamic>{'number': instance.number, 'picUrl': instance.picUrl, 'price': instance.price, 'id': instance.id, 'goodsName': instance.goodsName, 'specifications': instance.specifications};
