    ...
    return Container(
      ...
      child: Card(
        child: Row(
          ...
          children: <Widget>[
            CachedImageView(ScreenUtil.instance.setWidth(120.0), ScreenUtil.instance.setWidth(120.0), groupBuyEntity.picUrl),
            Padding(
                ...
                Row(
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(fontSize: ScreenUtil.instance.setSp(24.0), color: Colors.grey[850], decoration: TextDecoration.lineThrough, decorationStyle: TextDecorationStyle.dashed),
                    ),
                    Padding(
                    ...
                    Text(
                      ...
                      style: TextStyle(color: Colors.red, fontSize: ScreenUtil.instance.setSp(24.0), fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
              ],
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                      border: new Border.all(color: Colors.deepOrangeAccent, width: 0.5),
                      // 边色与边宽度
