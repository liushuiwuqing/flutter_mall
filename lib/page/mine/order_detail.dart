  ...
  Widget _contentView() {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ItemTextView(Strings.MINE_ORDER_SN, _orderDetailEntity.orderInfo.orderSn),
          DividerLineView(),
          ItemTextView(Strings.MINE_ORDER_TIME, _orderDetailEntity.orderInfo.addTime),
          DividerLineView(),
          Container(
          ...
          DividerLineView(),
          Container(
            margin: EdgeInsets.only(left: ScreenUtil.instance.setWidth(20.0), top: ScreenUtil.instance.setHeight(20.0), bottom: ScreenUtil.instance.setHeight(20.0)),
            child: Column(
          ...
          DividerLineView(),
          ItemTextView(Strings.MINE_ORDER_DETAIL_TOTAL, Strings.DOLLAR + "${_orderDetailEntity.orderInfo.goodsPrice}"),
          DividerLineView(),
          ItemTextView(Strings.FREIGHT, Strings.DOLLAR + "${_orderDetailEntity.orderInfo.freightPrice}"),
          DividerLineView(),
          ItemTextView(Strings.MINE_ORDER_DETAIL_PREFERENCES, Strings.DOLLAR + "${_orderDetailEntity.orderInfo.couponPrice}"),
          DividerLineView(),
          ItemTextView(Strings.MINE_ORDER_DETAIL_PAYMENTS, Strings.DOLLAR + "${_orderDetailEntity.orderInfo.actualPrice}"),
          DividerLineView(),
          Container(
            ...
            child: Row(
              children: <Widget>[
                Expanded(
                  ...
                  child: Text(
                    Strings.CANCEL,
                    style: TextStyle(fontSize: ScreenUtil.instance.setSp(28.0), color: Colors.white),
                  ),
                )),
                Padding(
                  padding: EdgeInsets.only(left: ScreenUtil.instance.setWidth(60.0)),
                ),
                Expanded(
                    child: MaterialButton(
                  color: Colors.deepOrangeAccent,
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
              action == 1 ? Strings.MINE_ORDER_CANCEL_TIPS : Strings.MINE_ORDER_DELETE_TIPS,
              style: TextStyle(color: Colors.black54, fontSize: ScreenUtil.instance.setSp(28.0)),
            ),
            actions: <Widget>[
              FlatButton(
